...
button {
  padding: 20px 40px;
  background-color: #42b983; /* Vibrant green */
  color: white;
  border: none;
  cursor: pointer;
  font-size: 1.2em;
...
button:hover {
  background-color: #369f6e; /* Slightly darker green for hover effect */
}
...
@media (max-width: 430px) {
  ...
  .column {
    margin: 20px 0; /* Add margin to separate stacked columns */
  }
}
